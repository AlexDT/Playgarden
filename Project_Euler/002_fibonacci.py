...
def sum_even_fib_numbers(x):
  ...
  a, b, c = 0, 1, 0
  total = 0
  # Keeps adding until fibonacci number reaches 4.000.000
  while total < x:
    c = a + b
    a = b
    b = c
    # Checks if fibonacci number is even
    if c % 2 == 0:
      total = total + c
  return total

max = input("Maximum fibonacci number to add to the total? [integer]\n")
# Takes the string input and converts to integer
print sum_even_fib_numbers(int(max))
